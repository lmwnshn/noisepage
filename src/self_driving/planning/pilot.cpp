...
void Pilot::ActionSearch(std::vector<std::pair<const std::string, catalog::db_oid_t>> *best_action_seq) {
  ...
  //  mcst.BestAction(simulation_number_, best_action_seq, pilot::ChildSamplingType::RANDOM);
  //  mcst.BestAction(simulation_number_, best_action_seq, pilot::ChildSamplingType::RANDOM);
  mcst.BestAction(simulation_number_, best_action_seq, pilot::ChildSamplingType::MCTS);
